...
from samples.worm import PR_segmentation

matplotlib.get_backend()
matplotlib.use("TkAgg")

config = PR_segmentation.WormConfig()
...
dataset_file="D:\\projects\\MG\\list_Justin.txt"
...
# Load dataset
if config.NAME == 'worm':
    dataset = PR_segmentation.WormDataset()
    dataset.load_pairs(dataset_file, subset=0.90)
...
for image_id in range(0, len(dataset.image_ids),1000):
#for image_id in range(0, 307, 1):
    ...
    #         # Display image and instances
        ...
        visualize.display_instances(img_scaled, bbox, mask, class_ids, dataset.class_names, None, "", (16, 16),None, True, False, color)
        plt.close()
...
#     print("Average percent: {:.2f}".format(total/(limit*i
